...
\raggedright
\hdr{EDUCATION}\\
\textbf{\underline{University of California, Berkeley}} \hfill May 2026\\
Jointly advised by Bernd Sturmfels and Serkan Ho\c{s}ten\\
...
\begin{itemize}
\item Visit to Max Planck Institute for Mathematics in the Sciences \hfill Leipzig, Summers 2023-2026
\item Geometric Methods in Optimization and Numerical Analysis \hfill MFO Oberwolfach, July, 2026
\item Visit to Academy of Mathematics and Systems Science, CAS \hfill Beijing, July 2026
\item Organized Metric Algebraic Geometry: Starting Local \hfill MPI MiS, April 2026
  \item Combinatorical Coworkspace \hfill Kleinwalsertal, March 2026
...
\hdr{PUBLICATIONS}\\
\begin{itemize}
\item Hannah Friedman. Maximum Likelihood Estimation on the Grassmannian of Lines. Submitted (2026).
\item Hannah Friedman, Andrea Rosana, Bernd Sturmfels. Distance Optimization in the Grassmannian of Lines. Submitted (2026). 
\item Viktoriia Borovik, Hannah Friedman, Serkan Ho\c{s}ten, Max Pfeffer.
...
\item Hannah Friedman, Bernd Sturmfels, Max Wiesmann.
  ...
  \textit{SIAM Journal on Applied Algebra and Geometry}
         {\bf 10} (2026) 153--173. 
...
\begin{itemize}
\item Maximum Likelihood Estimation for Statistical Models on the Grassmannian. \\
  $\spadesuit$   Geometric Methods in Optimization and Numerical Analysis, Oberwolfach, July 2026.
\item Numerical Algebraic Geometry for Energy Computations on Tensor Train Varieties.\\
  $\spadesuit$ Effective Methods in Algebraic Geometry, July 2026.
\item The ML Degree of the Grassmannian\\
  $\spadesuit$ Metric Algebraic Geometry at Institut Mittag-Leffler, June 2026. 
\item Metric Algebraic Geometry of the Grassmannian of Lines.\\
  $\diamondsuit$ Oberseminar at Universität Magdeburg, April 2026.\\
  $\diamondsuit$ Algebra Seminar at Universität Osnabrück, April 2026.
\item Distance Optimization.\\
  $\diamondsuit$ Metric Algebraic Geometry: Starting Local, April 2026. 
...
\begin{itemize}
\item Unbounded Representation Leader, Fall 2024 -- Fall 2025
